...
docker run --rm --volumes-from wger_web -v /home/joe/backup:/wgerbackup ubuntu bash -c "cd /home/wger/media && tar cvf /wgerbackup/$today-wger-media-backup.tar . ; cd /home/wger/static && tar cvf /wgerbackup/$today-wger-static-backup.tar ."

docker start wger_db
docker start wger_web
